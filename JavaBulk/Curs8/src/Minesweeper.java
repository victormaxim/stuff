...
public class Minesweeper extends JFrame implements ActionListener {
	...
	//private static final long serialVersionUID = 930723501145590734L;
	Icon ico1 = new ImageIcon("pros.png");
...
//right click event on B[][] buttons
		for (int i = 0; i < 10; i++) {
			for (int j = 0; j < 10; j++) {
...
public void actionPerformed(ActionEvent ev) {
		...
		if (bomb) {
			...
			if((20-disc) ==1){
				JOptionPane.showMessageDialog(null, "MineSweeper", "1 more mine to go!",JOptionPane.INFORMATION_MESSAGE);}
			
			if((20-disc) ==0){
				JOptionPane.showMessageDialog(null, "MineSweeper", "You've won!!!",	JOptionPane.INFORMATION_MESSAGE);
