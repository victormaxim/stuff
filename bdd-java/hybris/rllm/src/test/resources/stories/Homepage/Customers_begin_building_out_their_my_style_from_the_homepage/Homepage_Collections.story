Scenario: Homepage_AC16_1 User navigates the homepage and checks a collection that has new products added to it.
Meta:
@waiting
...
Scenario: Homepage_AC17_1 Female user navigates the homepage and checks the collections carousel
Meta:
@waiting
Given the user authenticates with 'rueQAFemaleUser@mailinator.com' and 'rueQAFemalePassword'
And the user is on 'Homepage' page
...
Scenario: Homepage_AC18_1 Male user navigates the homepage and checks the collections carousel
Meta:
@waiting
